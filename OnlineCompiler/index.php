...
<!-- <div class="main">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top nbar">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="space"><a href="tryit.php"><i class="fa fa-cogs ispace"></i>html and css</a></li>
     ...
     <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="myNavbar" >
            <ul class="nav navbar-nav   pull-right">
              ...
              <li><a href="./tryit.php">HTML COMPILER</a></li>
...
<a href="compilers/tryit.php" title=""><option value="html">html,css,javascript</option></a>
<!-- <a href="OnlineCompiler/compiles/tryit.php" title=""></a> -->
...
<input type="submit" id="st" name="run" class="btn btn-success" value="Run Code"><br><br><br>
...
<b>Developed By Jignesh Thakur</b>
